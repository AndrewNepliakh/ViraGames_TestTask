...
{
    public const string POINTERS_POSITION = "PointersPosition";
    ...
    public const string SWITCH_BUTTON_ACTION = "SwitchButtonAction";
    ...
    public const string SPIRAL_SCENE_PATH = "Prefabs/Scenes/SpiralScene";

    public const string MOVE_WINDOW_PATH = "Prefabs/UI/MoveWindow";
    public const string ROTATE_WINDOW_PATH = "Prefabs/UI/RotateWindow";
    public const string SPIRAL_WINDOW_PATH = "Prefabs/UI/SpiralWindow";
